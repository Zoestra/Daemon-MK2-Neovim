...
-- This is the Daemon MK2 colorscheme for Neovim, built with Lush.
...
--
--       "daemon-mk2/lua/lush_theme/daemon.lua",
--
--       not,
--
--       "daemon-mk2/lua/daemon.lua".
--
...
local theme = lush(function(injected_functions)
    ...
    return {
        ...
        -- CursorLineNr({ fg = hsl(323, 73, 61) }), -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
        ...
        StatusLine({ bg = hsl(1, 100, 11) }), -- Status line of current window
